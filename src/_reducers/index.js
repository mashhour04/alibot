...
export default combineReducers({ authentication, deals, alert, profile, seats, sideBar, register, toastr: toastrReducer, vendor, tables, movies, bookings, pastBookings, availableTables, addBooking })